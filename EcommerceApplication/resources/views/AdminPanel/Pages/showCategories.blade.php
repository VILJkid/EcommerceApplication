            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/showCategories">Show Categories</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover text-center">
                                ...
                                <tbody>
                                    {{-- If no records found --}}
                                    @if (empty($aData[0]->category_name))
                                        <tr>
                                            <td class="align-middle" colspan="3">Nothing
                        ...
                        <div class="card-footer clearfix">
                            <a href="/addCategory" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Add
                                Users</a>
                        </div>
                    </div>
                </div>
            ...
            $('.edit').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#category_name").attr('placeholder', response.category_name);
